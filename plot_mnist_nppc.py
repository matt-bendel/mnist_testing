...
restoration_net = restoration_net.load('./results/mnist_inpainting/restoration/checkpoint.pt')
...
nppc_model = nppc_model.load('./results/mnist_inpainting/nppc/checkpoint.pt')
nppc_model.net.eval()
